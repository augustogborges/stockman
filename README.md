...
Escrito em Qt (QtQuick e QML) e Python, ele oferece segurança por login (usuário e senha sempre armazenados em hash, impossibilitando ataques de leitura plain-text) e encripção da base de dados (json é criptografado sempre que é detectado um logout).
